        ...
        <div class="fullPage">
            ...
            <div class="users">
                <ul v-for="(chunk, index) in filter(filteredUsers, 6)" :key="index" class="usersPart">
                    <li v-for="(user, i) in chunk" :key="i" class="user" @click="userDetails(user.id)">
                        ...
                        <div v-if="user.isParticipated" class="isParticipated" >Participe à l'évènement</div>
                        <div v-else class="isNotParticipated">Ne participe pas à l'évènement</div>
                    </li>
                </ul>
            </div>
        </div>
